...
function createUser(username, email, password, accountType, name_first, name_last) {
    ...
    var purchaseTypeList = ['Rent', 'Food', 'Entertainment', 'Travel', 'Utilities', 'Savings', 'Personal'];

    console.log(getCost(0));
...
function getCost (pos) {
    var cost = [];
    // var purchaseTypeList = ['Rent', 'Food', 'Entertainment', 'Travel', 'Utilities', 'Savings', 'Personal'];
    cost[0] = Number(1199.99);
    cost[1] = Number(199.99);
    cost[2] = Number(119.9);
    cost[3] = Number(1299.99);
    cost[4] = Number(59.99);
    cost[5] = Number(499.99);
    cost[6] = Number(239.99);
    return Math.round(cost[pos]);
}
        ...
        if (error) {
            ...
            if (userLog === null) {
                ...
                for (var i = 0; i < userLog.account.purchaseHistory.length; i++) {
                    ...
                    out[i] = [item.datePurchased, 4800 + getRandomInt(400) - 20];
                }
